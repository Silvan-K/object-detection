class LabelledBox():
    """
    A class for representing labelled boxes

    """

    def __init__(self, x0, x1, y0, y1, label):
        """
        Create a LabelledBox instance from upper left box coordinate 
        (x0, y0), lower right box coordinate (x1, y1), and the passed label.
